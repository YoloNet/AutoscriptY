...
<h2 align="center"> RECCOMENDED DEBIAN 12(tested)</h2>
...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/YoloNet/AutoscriptY/main/setupku.sh && chmod +x setupku.sh && sed -i -e 's/\r$//' setupku.sh && screen -S setupku ./setupku.sh

  ```
## INSTALLATION LINK IF ASKED

  ```html
  raw.githubusercontent.com/YoloNet/AutoscriptY/main
