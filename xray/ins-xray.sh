...
# ==========================================
# =========================================
# VPN Quick Setup | Script Setup Manager
# =========================================
...
# install nginx
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://${HOST_URL}/main/conf/vps.conf"
sleep 1
wget -q -O xraymode.sh https://${HOST_URL}/xray/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O /etc/xray/config.json "https://${HOST_URL}/conf/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://${HOST_URL}/conf/xray.conf"
